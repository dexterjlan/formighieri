...
async function fetchGestaoProjectsByOrderIds(orderIds) {
    ...
    const selectVariants = [
        ...
        'id, orderId, projectCode, name, environmentTypeId, saleValue, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath, environmentType:EnvironmentType(name)',
        'id, orderId, projectCode, name, environmentTypeId, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath, environmentType:EnvironmentType(name), projectStatus:OrderProjectStatus(id, name)',
        'id, orderId, projectCode, name, environmentTypeId, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath, environmentType:EnvironmentType(name)',
        'id, orderId, projectCode, name, environmentTypeId, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath',
...
async function fetchGestaoOrders(filters = {}) {
    ...
    const orderSelectVariants = [
        ...
        `*, ${orderRelations}, projects:OrderProject(id, projectCode, name, environmentTypeId, saleValue, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath, environmentType:EnvironmentType(name))`,
        `*, ${orderRelations}, projects:OrderProject(id, projectCode, name, environmentTypeId, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath, environmentType:EnvironmentType(name), projectStatus:OrderProjectStatus(id, name))`,
        `*, ${orderRelations}, projects:OrderProject(id, projectCode, name, environmentTypeId, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath, environmentType:EnvironmentType(name))`,
        `*, ${orderRelations}, projects:OrderProject(id, projectCode, name, environmentTypeId, deliveryDate, statusId, designerId, approvalNetworkPath, conferenceNetworkPath)`,
    ...
    const payloadVariants = [
        {
            ...
            conferenceNetworkPath: project.conferenceNetworkPath,
            ...complementaryFields,
            ...replacedFields,
